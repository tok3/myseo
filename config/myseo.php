...
$config['myseo_filters'] = array(
    ...
    'articles' => array(
        'hide_drafts' => array(
            'type' => 'checkbox',
            'title' => 'myseo:articles:filters:fields:draft',
            'title_long' => 'myseo:articles:filters:fields:long:draft'
        ),
        'category' => array(
            'type' => 'dropdown_from_model',
            'method' => 'categories',
            'title' => 'myseo:articles:filters:fields:category',
            'title_long' => 'myseo:articles:filters:fields:long:category'
        ),
        'by_title' => array(
            'type' => 'input',
            'title' => 'myseo:articles:filters:fields:title',
            'title_long' => 'myseo:articles:filters:fields:long:title'
        ),
        'by_slug' => array(
            'type' => 'input',
            'title' => 'myseo:articles:filters:fields:slug',
            'title_long' => 'myseo:articles:filters:fields:long:slug'
        )
    )
);