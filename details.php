...
class Module_Myseo extends Module
{
    ...
    public function install()
    {
        ...
        $this->dbforge->drop_table('myseo_articles_meta');
...
public function upgrade($old_version)
{
    ...
    if (!$this->db->table_exists('myseo_articles_meta'))
    {
